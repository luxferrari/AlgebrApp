...
public final class AlgebrApp implements EntryPoint {	
	...
	public void onModuleLoad() {
		...
		statistics.addStyleName("statistics");
	...
	private static Polynomial createTestPoly() {
		...
		//p1.addMonomial(rndGenerator.randomMonomials(2, ordine-2, rangeCoefficienti, numLettere));
		...
		//p2.insertSubPolynomial(p1, 1, false);
		//p2.addMonomial(rndGenerator.randomMonomials(2, ordine, rangeCoefficienti, 1));
		poly.insertItem(p2, 0, true, true, 15);

		poly.refresh();

		//System.err.println("p1: "+p1.getParenthesisLevel()+" p2: "+p2.getParenthesisLevel());
		return poly;
	}
